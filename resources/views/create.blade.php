            ...
            <form method="POST" action="{{ route('account.store') }}">
                ...
                @method('post')
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Masukkan Nama User" name="user_name">
                    </div >
        
                    <div class="form-group">
                        <label for="exampleInputEmail">User Email</label><br>
                        <input class="form-control" type="email" placeholder="Masukkan Email" name="user_email">
                    </div>
